...
CREATE INDEX IF NOT EXISTS "consultation_notes_deleted_at_idx" ON "consultation_note" USING btree ("deleted_at");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "consultation_notes_draft_idx" ON "consultation_note" USING btree ("provider_id","created_at") WHERE "consultation_note"."status" = 'draft';
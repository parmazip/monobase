...
import type { CreateProviderBody } from '@/generated/openapi/validators';
 ...
 */
export async function createProvider(ctx: ValidatedContext<CreateProviderBody, never, never>) {
